...
SEED: list[dict] = [
    ...
    {"name": "Cairn Lodge Services", "ref": "M74", "lat": 55.5004, "lon": -3.8003, "side": "single", "play_type": "both", "source": "operator"},
    {"name": "Gretna Green Services", "ref": "A74(M)", "lat": 55.0316, "lon": -3.0700, "side": "single", "play_type": "both", "source": "operator"},
    # Moto — indoor soft play (documented).
    {"name": "Leigh Delamere Services (west)", "ref": "M4", "lat": 51.4993, "lon": -2.1583, "side": "SB", "play_type": "indoor_soft_play", "source": "operator"},
    {"name": "Donington Park Services", "ref": "M1", "lat": 52.8316, "lon": -1.3170, "side": "both", "play_type": "indoor_soft_play", "source": "operator"},
    # A-road / other documented.
    {"name": "Cornwall Services", "ref": "A30", "lat": 50.3897, "lon": -4.8038, "side": "single", "play_type": "indoor_soft_play", "source": "operator"},
    {"name": "Chieveley Services", "ref": "M4", "lat": 51.4736, "lon": -1.2876, "side": "both", "play_type": "indoor_soft_play", "source": "mso"},
    # Extra — play areas across the chain (documented).
    {"name": "Cambridge Services", "ref": "A14", "lat": 52.2900, "lon": -0.0500, "side": "both", "play_type": "outdoor", "source": "operator"},
    {"name": "Beaconsfield Services", "ref": "M40", "lat": 51.6087, "lon": -0.6360, "side": "both", "play_type": "outdoor", "source": "operator"},
    {"name": "Cobham Services", "ref": "M25", "lat": 51.3210, "lon": -0.3940, "side": "both", "play_type": "outdoor", "source": "operator"},
    {"name": "Peterborough Services", "ref": "A1(M)", "lat": 52.5300, "lon": -0.2400, "side": "both", "play_type": "outdoor", "source": "operator"},
    {"name": "Baldock Services", "ref": "A1(M)", "lat": 51.9900, "lon": -0.1900, "side": "both", "play_type": "outdoor", "source": "operator"},
    {"name": "Leeds Skelton Lake Services", "ref": "M1", "lat": 53.7780, "lon": -1.4660, "side": "both", "play_type": "both", "source": "operator"},
]
